...
function applyEvents_11010073(n_11010075) {
    ...
    L1: do {
      var i_11010089 = 0;
      var colontmp__11640275 = 0;
      colontmp__11640275 = (n_11010075.events).length;
      var i_11640276 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640276 < colontmp__11640275)) break L3;
            i_11010089 = i_11640276;
...
function applyStyle_10455628(n_10455630, s_10455631) {
    ...
    L1: do {
      var i_10455664 = 0;
      var colontmp__11640286 = 0;
      colontmp__11640286 = (s_10455631.length - 1);
      var res_11640287 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11640287 <= colontmp__11640286)) break L3;
            i_10455664 = res_11640287;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      L1: do {
        ...
        L2: do {
          var i_11640255 = 0;
          var colontmp__11640256 = 0;
          colontmp__11640256 = (n_11010156.kids).length;
          var i_11640257 = 0;
          L3: do {
              L4: while (true) {
              if (!(i_11640257 < colontmp__11640256)) break L4;
                i_11640255 = i_11640257;
                k_11135016 = n_11010156.kids[i_11640255];
    ...
    L5: do {
      ...
      L6: do {
        var i_11640268 = 0;
        var colontmp__11640269 = 0;
        colontmp__11640269 = ((n_11010156.attrs).length - 2);
        var res_11640270 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11640270 <= colontmp__11640269)) break L8;
              i_11640268 = res_11640270;
              k_11150001 = n_11010156.attrs[i_11640268];
              v_11150002 = n_11010156.attrs[(i_11640268 + 1)];
              if (!((v_11150002 == null))) {
...
function same_11160072(n_11160074, e_11160075, nesting_11160076) {
  ...
  BeforeRet: do {
    ...
    L3: do {
      var i_11175024 = 0;
      var colontmp__11640293 = 0;
      colontmp__11640293 = len_10550014(n_11160074);
      var i_11640294 = 0;
      L4: do {
          L5: while (true) {
          if (!(i_11640294 < colontmp__11640293)) break L5;
            i_11175024 = i_11640294;
...
function eq_10420229(a_10420231, b_10420232) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10425083 = 0;
      var colontmp__11640335 = 0;
      colontmp__11640335 = a_10420231.length;
      var i_11640336 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640336 < colontmp__11640335)) break L3;
            i_10425083 = i_11640336;
...
function sameAttrs_10561079(a_10561081, b_10561082) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_10561106 = 0;
      var colontmp__11640339 = 0;
      colontmp__11640339 = (a_10561081.attrs).length;
      var i_11640340 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640340 < colontmp__11640339)) break L3;
            i_10561106 = i_11640340;
...
function eq_11175214(a_11175216, b_11175217, recursive_11175218) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      var i_11205008 = 0;
      var colontmp__11640327 = 0;
      colontmp__11640327 = len_10550014(a_11175216);
      var i_11640328 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640328 < colontmp__11640327)) break L3;
            i_11205008 = i_11640328;
    ...
    L6: do {
      var i_11230008 = 0;
      var colontmp__11640331 = 0;
      colontmp__11640331 = len_10550014(a_11175216);
      var i_11640332 = 0;
      L7: do {
          L8: while (true) {
          if (!(i_11640332 < colontmp__11640331)) break L8;
            i_11230008 = i_11640332;
...
function updateAttributes_11245052(newNode_11245054, oldNode_11245055) {
    ...
    L1: do {
      ...
      L2: do {
        var i_11640345 = 0;
        var colontmp__11640346 = 0;
        colontmp__11640346 = ((oldNode_11245055.attrs).length - 2);
        var res_11640347 = 0;
        L3: do {
            L4: while (true) {
            if (!(res_11640347 <= colontmp__11640346)) break L4;
              i_11640345 = res_11640347;
              k_11250009 = oldNode_11245055.attrs[i_11640345];
              __11250010 = oldNode_11245055.attrs[(i_11640345 + 1)];
    ...
    L5: do {
      ...
      L6: do {
        var i_11640353 = 0;
        var colontmp__11640354 = 0;
        colontmp__11640354 = ((newNode_11245054.attrs).length - 2);
        var res_11640355 = 0;
        L7: do {
            L8: while (true) {
            if (!(res_11640355 <= colontmp__11640354)) break L8;
              i_11640353 = res_11640355;
              k_11250011 = newNode_11245054.attrs[i_11640353];
              v_11250012 = newNode_11245054.attrs[(i_11640353 + 1)];
              if (!((v_11250012 == null))) {
...
function removeAllEventHandlers_10897436(d_10897438) {
    ...
    L1: do {
      var i_10900041 = 0;
      var colontmp__11640360 = 0;
      colontmp__11640360 = d_10897438.karaxEvents.length;
      var i_11640361 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640361 < colontmp__11640360)) break L3;
            i_10900041 = i_11640361;
...
function diff_11310215(newNode_11310217, oldNode_11310218, parent_11310219, current_11310220, kxi_11310221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      L7: do {
        var i_11340024 = 0;
        var colontmp__11640302 = 0;
        colontmp__11640302 = (pos_11340018 - 1);
        var res_11640303 = commonPrefix_11330202;
        L8: do {
            L9: while (true) {
            if (!(res_11640303 <= colontmp__11640302)) break L9;
              i_11340024 = res_11640303;
      ...
      L10: do {
        var i_11340030 = 0;
        var res_11640309 = pos_11340018;
        L11: do {
            L12: while (true) {
            if (!(res_11640309 <= newPos_11330215)) break L12;
              i_11340030 = res_11640309;
        ...
        L13: do {
          var i_11340037 = 0;
          var res_11640315 = pos_11340018;
          L14: do {
              L15: while (true) {
              if (!(res_11640315 <= newPos_11330215)) break L15;
                i_11340037 = res_11640315;
      ...
      L16: do {
        var i_11340043 = 0;
        var res_11640321 = pos_11340018;
        L17: do {
            L18: while (true) {
            if (!(res_11640321 <= oldPos_11330214)) break L18;
              i_11340043 = res_11640321;
...
function moveDom_11270048(dest_11270050, src_11270051) {
    ...
    L1: do {
      var i_11285208 = 0;
      var colontmp__11640372 = 0;
      colontmp__11640372 = len_10550014(dest_11270050);
      var i_11640373 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11640373 < colontmp__11640372)) break L3;
            i_11285208 = i_11640373;
...
function applyPatch_11285222(kxi_11285224) {
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11640366 < kxi_11285224.patchLen)) break L3;
            i_11285232 = i_11640366;
    ...
    L4: do {
      ...
      L5: do {
          L6: while (true) {
          if (!(i_11640369 < kxi_11285224.patchLenV)) break L6;
            i_11295013 = i_11640369;
...
function tree_10560445(kind_10560447, kids_10560449) {
  var result_10560450 = null;
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11640395 < (kids_10560449).length)) break L3;
            k_10560483 = kids_10560449; k_10560483_Idx = i_11640395;
...
function setAttr_10500105(n_10500107, key_10500108, val_10500109) {
  BeforeRet: do {
    ...
    n_10500107.attrs = nimCopy(null, [key_10500108, val_10500109], NTI10500125);
      ...
      L1: do {
        var i_10500138 = 0;
        var colontmp__11640402 = 0;
        colontmp__11640402 = ((n_10500107.attrs).length - 2);
        var res_11640403 = 0;
        L2: do {
            L3: while (true) {
            if (!(res_11640403 <= colontmp__11640402)) break L3;
              i_10500138 = res_11640403;
...
function navbar_11550043() {
  var result_11550045 = null;

    var tmp_11550046 = tree_10560445(18, []);
    tmp_11550046.class = "navbar";
    var tmp_11550047 = tree_10560445(44, []);
    setAttr_10500105(tmp_11550047, "href", "/");
    var tmp_11550048 = tree_10560445(70, []);
    tmp_11550048.id = "logo";
    add_10550072(tmp_11550047, tmp_11550048);
    add_10550072(tmp_11550046, tmp_11550047);
    result_11550045 = tmp_11550046;

  return result_11550045;
...
function cancel_11542044(action_11542050) {
  var result_11542051 = null;

    var tmp_11542088 = tree_10560445(43, []);
    tmp_11542088.id = "cancel";
    addEventHandler_11460118(tmp_11542088, 0, action_11542050, kxi_10897284[0]);
    var tmp_11542094 = tree_10560445(43, []);
    tmp_11542094.id = "cancelline1";
    add_10550072(tmp_11542088, tmp_11542094);
    var tmp_11542095 = tree_10560445(43, []);
    tmp_11542095.id = "cancelline2";
    add_10550072(tmp_11542088, tmp_11542095);
    result_11542051 = tmp_11542088;

  return result_11542051;
...
function auth_11595021(cancelproc_11595027) {
function login_11595029() {
  var result_11595031 = null;

    var tmp_11595032 = tree_10560445(43, []);
    tmp_11595032.id = "authmode";
    var tmp_11595033 = tree_10560445(43, []);
    tmp_11595033.class = "authcapsule";
    var tmp_11595034 = tree_10560445(104, []);
    add_10550072(tmp_11595034, text_10560582(makeNimstrLit("Username")));
    add_10550072(tmp_11595033, tmp_11595034);
    var tmp_11595035 = tree_10560445(105, []);
    setAttr_10500105(tmp_11595035, "type", "text");
    setAttr_10500105(tmp_11595035, "placeholder", "username");
    add_10550072(tmp_11595033, tmp_11595035);
    add_10550072(tmp_11595032, tmp_11595033);
    var tmp_11595036 = tree_10560445(43, []);
    tmp_11595036.class = "authcapsule";
    var tmp_11595037 = tree_10560445(104, []);
    add_10550072(tmp_11595037, text_10560582(makeNimstrLit("Password")));
    add_10550072(tmp_11595036, tmp_11595037);
    var tmp_11595038 = tree_10560445(105, []);
    setAttr_10500105(tmp_11595038, "type", "password");
    setAttr_10500105(tmp_11595038, "placeholder", "password");
    add_10550072(tmp_11595036, tmp_11595038);
    add_10550072(tmp_11595032, tmp_11595036);
    var tmp_11595039 = tree_10560445(106, []);
    setAttr_10500105(tmp_11595039, "type", "button");
    add_10550072(tmp_11595039, text_10560582(makeNimstrLit("Login")));
    add_10550072(tmp_11595032, tmp_11595039);
    result_11595031 = tmp_11595032;

  return result_11595031;

}
    function showLogin_11605082(ev_11605084, n_11605085) {
        var canvas_11605086 = document.getElementById("auth");
        var previtem_11605087 = document.getElementById("authmode");
        canvas_11605086.replaceChild(vnodeToDom_11470073(login_11595029(), null), previtem_11605087);

      
    }
function register_11600046() {
  var result_11600048 = null;

    var tmp_11600049 = tree_10560445(43, []);
    tmp_11600049.id = "authmode";
    var tmp_11600050 = tree_10560445(43, []);
    tmp_11600050.class = "authcapsule";
    var tmp_11600051 = tree_10560445(104, []);
    add_10550072(tmp_11600051, text_10560582(makeNimstrLit("Username")));
    add_10550072(tmp_11600050, tmp_11600051);
    var tmp_11600052 = tree_10560445(105, []);
    setAttr_10500105(tmp_11600052, "type", "text");
    setAttr_10500105(tmp_11600052, "placeholder", "username");
    add_10550072(tmp_11600050, tmp_11600052);
    add_10550072(tmp_11600049, tmp_11600050);
    var tmp_11600053 = tree_10560445(43, []);
    tmp_11600053.class = "imgcapsule";
    var tmp_11600054 = tree_10560445(104, []);
    tmp_11600054.id = "whatsapp";
    tmp_11600054.class = "formimg";
    add_10550072(tmp_11600053, tmp_11600054);
    var tmp_11600055 = tree_10560445(105, []);
    setAttr_10500105(tmp_11600055, "type", "tel");
    setAttr_10500105(tmp_11600055, "placeholder", "whatsapp number");
    add_10550072(tmp_11600053, tmp_11600055);
    add_10550072(tmp_11600049, tmp_11600053);
    var tmp_11600056 = tree_10560445(43, []);
    tmp_11600056.class = "authcapsule";
    var tmp_11600057 = tree_10560445(104, []);
    add_10550072(tmp_11600057, text_10560582(makeNimstrLit("Email")));
    add_10550072(tmp_11600056, tmp_11600057);
    var tmp_11600058 = tree_10560445(105, []);
    setAttr_10500105(tmp_11600058, "type", "email");
    setAttr_10500105(tmp_11600058, "placeholder", "email");
    add_10550072(tmp_11600056, tmp_11600058);
    add_10550072(tmp_11600049, tmp_11600056);
    var tmp_11600059 = tree_10560445(43, []);
    tmp_11600059.class = "authcapsule";
    var tmp_11600060 = tree_10560445(104, []);
    add_10550072(tmp_11600060, text_10560582(makeNimstrLit("Password")));
    add_10550072(tmp_11600059, tmp_11600060);
    var tmp_11600061 = tree_10560445(105, []);
    setAttr_10500105(tmp_11600061, "type", "password");
    setAttr_10500105(tmp_11600061, "placeholder", "password");
    add_10550072(tmp_11600059, tmp_11600061);
    add_10550072(tmp_11600049, tmp_11600059);
    var tmp_11600062 = tree_10560445(43, []);
    tmp_11600062.class = "authcapsule";
    var tmp_11600063 = tree_10560445(104, []);
    add_10550072(tmp_11600063, text_10560582(makeNimstrLit("Retype Password")));
    add_10550072(tmp_11600062, tmp_11600063);
    var tmp_11600064 = tree_10560445(105, []);
    setAttr_10500105(tmp_11600064, "type", "password");
    setAttr_10500105(tmp_11600064, "placeholder", "retype password");
    add_10550072(tmp_11600062, tmp_11600064);
    add_10550072(tmp_11600049, tmp_11600062);
    var tmp_11600065 = tree_10560445(106, []);
    setAttr_10500105(tmp_11600065, "type", "button");
    add_10550072(tmp_11600065, text_10560582(makeNimstrLit("Register")));
    add_10550072(tmp_11600049, tmp_11600065);
    result_11600048 = tmp_11600049;

  return result_11600048;

}
    function showRegister_11605101(ev_11605103, n_11605104) {
        var canvas_11605105 = document.getElementById("auth");
        var previtem_11605106 = document.getElementById("authmode");
        canvas_11605105.replaceChild(vnodeToDom_11470073(register_11600046(), null), previtem_11605106);

      
    }

  var result_11595028 = null;

    var tmp_11605120 = tree_10560445(70, []);
    tmp_11605120.id = "auth";
    var tmp_11605121 = tree_10560445(43, []);
    tmp_11605121.class = "cancelcontainer";
    add_10550072(tmp_11605121, cancel_11542044(cancelproc_11595027));
    add_10550072(tmp_11605120, tmp_11605121);
    var tmp_11605122 = tree_10560445(43, []);
    tmp_11605122.id = "authswap";
    var tmp_11605123 = tree_10560445(70, []);
    tmp_11605123.class = "authbtns";
    addEventHandler_11460118(tmp_11605123, 0, showLogin_11605082, kxi_10897284[0]);
    add_10550072(tmp_11605123, text_10560582(makeNimstrLit("Login")));
    add_10550072(tmp_11605122, tmp_11605123);
    var tmp_11605124 = tree_10560445(70, []);
    tmp_11605124.class = "authbtns";
    addEventHandler_11460118(tmp_11605124, 0, showRegister_11605101, kxi_10897284[0]);
    add_10550072(tmp_11605124, text_10560582(makeNimstrLit("Register")));
    add_10550072(tmp_11605122, tmp_11605124);
    add_10550072(tmp_11605120, tmp_11605122);
    add_10550072(tmp_11605120, register_11600046());
    result_11595028 = tmp_11605120;

  return result_11595028;

}
function exam_11555026(exam_11555028, action_11555033) {
  var result_11555034 = null;

    var tmp_11555035 = tree_10560445(43, []);
    tmp_11555035.class = "exams";
    addEventHandler_11460118(tmp_11555035, 0, action_11555033, kxi_10897284[0]);
    var tmp_11555036 = tree_10560445(75, []);
    setAttr_10500105(tmp_11555036, "alt", "examimage");
    setAttr_10500105(tmp_11555036, "src", toJSStr(exam_11555028.image));
    add_10550072(tmp_11555035, tmp_11555036);
    var tmp_11555037 = tree_10560445(70, []);
    var tmp_11555038 = tree_10560445(24, []);
    add_10550072(tmp_11555038, text_10560582(exam_11555028.name));
    add_10550072(tmp_11555037, tmp_11555038);
    var tmp_11555039 = tree_10560445(31, []);
    add_10550072(tmp_11555039, text_10560582(exam_11555028.description));
    add_10550072(tmp_11555037, tmp_11555039);
    add_10550072(tmp_11555035, tmp_11555037);
    result_11555034 = tmp_11555035;

  return result_11555034;
    ...
    L1: do {
        ...
        if (!(i_10320025 < (formatstr_10320019).length)) break L2;
          ...
          case 45:
            ...
            L3: do {
                L4: while (true) {
                  if (!(i_10320025 < (formatstr_10320019).length)) Tmp5 = false; else {                    Tmp5 = (ConstSet2[formatstr_10320019[i_10320025]] != undefined);                  }                if (!Tmp5) break L4;
          ...
          case 123:
            ...
            L8: do {
                L9: while (true) {
                if (!((j_10335006 < (formatstr_10320019).length) && !((ConstSet3[formatstr_10320019[j_10335006]] != undefined)))) break L9;
                  if ((ConstSet4[formatstr_10320019[j_10335006]] != undefined)) {
          ...
          case 95:
            ...
            L13: do {
                L14: while (true) {
                  if (!(j_10355006 < (formatstr_10320019).length)) Tmp15 = false; else {                    Tmp15 = (ConstSet6[formatstr_10320019[j_10355006]] != undefined);                  }                if (!Tmp15) break L14;
                  j_10355006 += 1;
                }
            } while(false);
...
function addQuoted_11625801(s_11625804, s_11625804_Idx, x_11625805) {
    addInt_1555201(s_11625804, s_11625804_Idx, x_11625805);

  
}
function collectionToString_11625671(x_11625674, prefix_11625675, separator_11625676, suffix_11625677) {
  var result_11625678 = [[]];

    result_11625678[0] = nimCopy(null, prefix_11625675, NTI1188013);
    var firstElement_11625679 = true;
    L1: do {
      var value_11625725 = 0;
      var i_11640501 = 0;
      if ((i_11640501 <= 1)) {
      L2: do {
          L3: while (true) {
          if (!true) break L3;
            value_11625725 = x_11625674[i_11640501];
            if (firstElement_11625679) {
            firstElement_11625679 = false;
            }
            else {
            result_11625678[0].push.apply(result_11625678[0], separator_11625676);;
            }
            
            addQuoted_11625801(result_11625678, 0, value_11625725);
            if ((1 <= i_11640501)) {
            break L2;
            }
    ...
    result_11625678[0].push.apply(result_11625678[0], suffix_11625677);;

  return result_11625678[0];

}
function HEX24_11625664(x_11625669) {
  var result_11625670 = [];

    result_11625670 = nimCopy(null, collectionToString_11625671(x_11625669, makeNimstrLit("["), makeNimstrLit(", "), makeNimstrLit("]")), NTI1188013);

  return result_11625670;

}
function configexam_11610036(exam_11610038, cancelproc_11610043) {
  var result_11610044 = null;

    var tmp_11610045 = tree_10560445(70, []);
    tmp_11610045.id = "auth";
    var tmp_11610046 = tree_10560445(43, []);
    tmp_11610046.class = "cancelcontainer";
    add_10550072(tmp_11610046, cancel_11542044(cancelproc_11610043));
    add_10550072(tmp_11610045, tmp_11610046);
    var tmp_11610047 = tree_10560445(43, []);
    tmp_11610047.id = "configexam";
    var tmp_11610048 = tree_10560445(70, []);
    tmp_11610048.id = "examstab";
    var tmp_11610049 = tree_10560445(75, []);
    setAttr_10500105(tmp_11610049, "src", toJSStr(exam_11610038.exam.image));
    add_10550072(tmp_11610048, tmp_11610049);
    var tmp_11610050 = tree_10560445(23, []);
    add_10550072(tmp_11610050, text_10560582(exam_11610038.exam.name));
    add_10550072(tmp_11610048, tmp_11610050);
    var tmp_11610051 = tree_10560445(31, []);
    add_10550072(tmp_11610051, text_10560582((makeNimstrLit("Time : ") || []).concat(exam_11610038.time || [])));
    add_10550072(tmp_11610048, tmp_11610051);
    var tmp_11610052 = tree_10560445(31, []);
    add_10550072(tmp_11610052, text_10560582(exam_11610038.exam.description));
    add_10550072(tmp_11610048, tmp_11610052);
    var tmp_11610053 = tree_10560445(106, []);
    setAttr_10500105(tmp_11610053, "type", "button");
    tmp_11610053.class = "btn";
    add_10550072(tmp_11610053, text_10560582(makeNimstrLit("Start Exam")));
    add_10550072(tmp_11610048, tmp_11610053);
    add_10550072(tmp_11610047, tmp_11610048);
    if (exam_11610038.multipleexams) {
    var tmp_11610054 = tree_10560445(70, []);
    tmp_11610054.id = "subjectstab";
    var tmp_11610055 = tree_10560445(43, []);
    tmp_11610055.class = "selectcontainer";
    var tmp_11610056 = tree_10560445(104, []);
    add_10550072(tmp_11610056, text_10560582(makeNimstrLit("Subjects")));
    add_10550072(tmp_11610055, tmp_11610056);
    L1: do {
      var each_11615057 = 0;
      var res_11640467 = 1;
      L2: do {
          L3: while (true) {
          if (!(res_11640467 <= exam_11610038.subjectnum)) break L3;
            each_11615057 = res_11640467;
            var tmp_11610057 = tree_10560445(107, []);
            tmp_11610057.class = "spinner";
            tmp_11610057.id = toJSStr((makeNimstrLit("subject") || []).concat(cstrToNimstr((each_11615057)+"") || []));
            L4: do {
              var each2_11625214 = null;
              var i_11640464 = 0;
              var L_11640465 = (exam_11610038.subjects).length;
              L5: do {
                  L6: while (true) {
                  if (!(i_11640464 < L_11640465)) break L6;
                    each2_11625214 = exam_11610038.subjects[i_11640464];
                    var tmp_11610058 = tree_10560445(110, []);
                    add_10550072(tmp_11610058, text_10560582(each2_11625214.name));
                    add_10550072(tmp_11610057, tmp_11610058);
                    i_11640464 += 1;
                  }
              } while(false);
            } while(false);
            add_10550072(tmp_11610055, tmp_11610057);
            res_11640467 += 1;
          }
      } while(false);
    } while(false);
    add_10550072(tmp_11610054, tmp_11610055);
    var tmp_11610059 = tree_10560445(43, []);
    tmp_11610059.class = "selectcontainer";
    var tmp_11610060 = tree_10560445(104, []);
    add_10550072(tmp_11610060, text_10560582(makeNimstrLit("Session")));
    add_10550072(tmp_11610059, tmp_11610060);
    var tmp_11610061 = tree_10560445(107, []);
    tmp_11610061.class = "spinner";
    tmp_11610061.id = "session";
    L7: do {
      var index_11625242 = 0;
      var colontmp__11640477 = 0;
      colontmp__11640477 = ((exam_11610038.sessions).length - 1);
      var res_11640482 = colontmp__11640477;
      L8: do {
          L9: while (true) {
          if (!(0 <= res_11640482)) break L9;
            index_11625242 = res_11640482;
            var tmp_11610062 = tree_10560445(110, []);
            add_10550072(tmp_11610062, text_10560582(nsuFormatVarargs(makeNimstrLit("$1/$2"), [HEX24_11625664([exam_11610038.sessions[index_11625242].from, exam_11610038.sessions[index_11625242].to])])));
            add_10550072(tmp_11610061, tmp_11610062);
            res_11640482 -= 1;
          }
      } while(false);
    } while(false);
    add_10550072(tmp_11610059, tmp_11610061);
    add_10550072(tmp_11610054, tmp_11610059);
    add_10550072(tmp_11610047, tmp_11610054);
    }
    
    add_10550072(tmp_11610045, tmp_11610047);
    result_11610044 = tmp_11610045;

  return result_11610044;

}
function footbar_11560035() {
    function column_11560038(data_11560047) {
      var result_11560048 = null;

        var tmp_11560049 = tree_10560445(35, []);
        tmp_11560049.class = "footcolumn";
        var tmp_11560050 = tree_10560445(24, []);
        add_10550072(tmp_11560050, text_10560582(data_11560047.Field0));
        add_10550072(tmp_11560049, tmp_11560050);
        L1: do {
          var each_11575214 = null;
          var i_11640509 = 0;
          var L_11640510 = (data_11560047.Field1).length;
          L2: do {
              L3: while (true) {
              if (!(i_11640509 < L_11640510)) break L3;
                each_11575214 = data_11560047.Field1[i_11640509];
                var tmp_11560051 = tree_10560445(44, []);
                setAttr_10500105(tmp_11560051, "href", toJSStr(each_11575214.Field1));
                add_10550072(tmp_11560051, text_10560582(each_11575214.Field0));
                add_10550072(tmp_11560049, tmp_11560051);
                i_11640509 += 1;
              }
          } while(false);
        } while(false);
        result_11560048 = tmp_11560049;

      return result_11560048;

    }

  var result_11560037 = null;

    var tmp_11575247 = tree_10560445(28, []);
    tmp_11575247.id = "footbar";
    add_10550072(tmp_11575247, column_11560038({Field0: makeNimstrLit("Legal"), Field1: [{Field0: makeNimstrLit("Terms and Conditions"), Field1: makeNimstrLit("/terms")}, {Field0: makeNimstrLit("Privacy policy"), Field1: makeNimstrLit("/policy")}]}));
    add_10550072(tmp_11575247, column_11560038({Field0: makeNimstrLit("Site"), Field1: [{Field0: makeNimstrLit("Developers"), Field1: makeNimstrLit("/devs")}, {Field0: makeNimstrLit("FAQ"), Field1: makeNimstrLit("/faq")}]}));
    result_11560037 = tmp_11575247;

  return result_11560037;

}
function footbar2_11580061() {
  var result_11580063 = null;

    var tmp_11580064 = tree_10560445(28, []);
    tmp_11580064.id = "footbar2";
    add_10550072(tmp_11580064, text_10560582(makeNimstrLit("Copyright \xC2\xA9 2021 Mockexams.com All Rights Reserved")));
    result_11580063 = tmp_11580064;

  return result_11580063;

}
function home_11627014() {
function cancel_11627017(ev_11627019, n_11627020) {
    var canvas_11627021 = document.getElementById("app");
    var prevchild_11627022 = document.getElementById("authcontainer");
    canvas_11627021.removeChild(prevchild_11627022);

  
}
    function showAuth_11627036(ev_11627038, n_11627039) {
        var canvas_11627040 = document.getElementById("app");
        var prevchild_11627041 = document.getElementById("authcontainer");
        var tmp_11627042 = tree_10560445(70, []);
        tmp_11627042.id = "authcontainer";
        add_10550072(tmp_11627042, auth_11595021(cancel_11627017));
        var nextchild_11630006 = tmp_11627042;
        canvas_11627040.appendChild(vnodeToDom_11470073(nextchild_11630006, null));
        canvas_11627040.removeChild(prevchild_11627041);

      
    }
    function examConfig_11630020(ev_11630022, n_11630023) {
        var testconfig_11630024 = {exam: {name: makeNimstrLit("UTME"), description: makeNimstrLit("      Practice utme computer based tests by using\x0A      mockexams tools\x0A      "), image: makeNimstrLit("/static/mockexamsapp/imgs/jamb.png"), time: 0, user: ({name: [], image: [], id: []}), subjects: []}, multipleexams: true, time: makeNimstrLit("120 min"), subjectnum: 0, subjects: [], sessions: []};
        var tmp_11630025 = tree_10560445(70, []);
        tmp_11630025.id = "authcontainer";
        add_10550072(tmp_11630025, configexam_11610036(testconfig_11630024, cancel_11627017));
        var nextchild_11635006 = tmp_11630025;
        var canvas_11635007 = document.getElementById("app");
        var prevchild_11635008 = document.getElementById("authcontainer");
        canvas_11635007.appendChild(vnodeToDom_11470073(nextchild_11635006, null));
        canvas_11635007.removeChild(prevchild_11635008);

      
    }

  var result_11627016 = null;

    var tmp_11635052 = tree_10560445(30, []);
    var tmp_11635053 = tree_10560445(70, []);
    tmp_11635053.class = "background";
    tmp_11635053.id = "topbackground";
    add_10550072(tmp_11635053, navbar_11550043());
    var tmp_11635054 = tree_10560445(70, []);
    var tmp_11635055 = tree_10560445(43, []);
    var tmp_11635056 = tree_10560445(22, []);
    add_10550072(tmp_11635056, text_10560582(makeNimstrLit("Ace your exams on the first try")));
    add_10550072(tmp_11635055, tmp_11635056);
    var tmp_11635057 = tree_10560445(37, []);
    add_10550072(tmp_11635057, text_10560582(makeNimstrLit("Practice authentic CBT past questions in a controlled enviroment")));
    add_10550072(tmp_11635055, tmp_11635057);
    var tmp_11635058 = tree_10560445(37, []);
    add_10550072(tmp_11635058, text_10560582(makeNimstrLit("Familiarize yourself with the test enviroment")));
    add_10550072(tmp_11635055, tmp_11635058);
    var tmp_11635059 = tree_10560445(37, []);
    add_10550072(tmp_11635059, text_10560582(makeNimstrLit("Get better with every attempt")));
    add_10550072(tmp_11635055, tmp_11635059);
    add_10550072(tmp_11635054, tmp_11635055);
    var tmp_11635060 = tree_10560445(106, []);
    setAttr_10500105(tmp_11635060, "type", "button");
    tmp_11635060.class = "btn";
    addEventHandler_11460118(tmp_11635060, 0, showAuth_11627036, kxi_10897284[0]);
    add_10550072(tmp_11635060, text_10560582(makeNimstrLit("Get Started")));
    add_10550072(tmp_11635054, tmp_11635060);
    add_10550072(tmp_11635053, tmp_11635054);
    add_10550072(tmp_11635052, tmp_11635053);
    var tmp_11635061 = tree_10560445(70, []);
    tmp_11635061.class = "background";
    tmp_11635061.id = "middlebackground";
    add_10550072(tmp_11635061, exam_11555026({name: makeNimstrLit("UTME"), description: makeNimstrLit("      Practice utme computer based tests by using\x0A      mockexams tools\x0A      "), image: makeNimstrLit("/static/mockexamsapp/imgs/jamb.png"), time: 0, user: ({name: [], image: [], id: []}), subjects: []}, examConfig_11630020));
    add_10550072(tmp_11635061, exam_11555026({name: makeNimstrLit("UTME"), description: makeNimstrLit("      Practice utme computer based tests by using\x0A      mockexams tools\x0A      "), image: makeNimstrLit("/static/mockexamsapp/imgs/abu.png"), time: 0, user: ({name: [], image: [], id: []}), subjects: []}, examConfig_11630020));
    add_10550072(tmp_11635061, exam_11555026({name: makeNimstrLit("UTME"), description: makeNimstrLit("      Practice utme computer based tests by using\x0A      mockexams tools\x0A      "), image: makeNimstrLit("/static/mockexamsapp/imgs/unilorin.png"), time: 0, user: ({name: [], image: [], id: []}), subjects: []}, examConfig_11630020));
    add_10550072(tmp_11635061, exam_11555026({name: makeNimstrLit("UTME"), description: makeNimstrLit("      Practice utme computer based tests by using\x0A      mockexams tools\x0A      "), image: makeNimstrLit("/static/mockexamsapp/imgs/unilag.png"), time: 0, user: ({name: [], image: [], id: []}), subjects: []}, examConfig_11630020));
    add_10550072(tmp_11635052, tmp_11635061);
    add_10550072(tmp_11635052, footbar_11560035());
    add_10550072(tmp_11635052, footbar2_11580061());
    result_11627016 = tmp_11635052;

  return result_11627016;

}
setRenderer_11455238(home_11627014, "app", null);
