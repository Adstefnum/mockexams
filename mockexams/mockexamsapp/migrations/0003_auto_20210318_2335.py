# Generated by Django 2.2.16 on 2021-03-18 23:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mockexamsapp', '0002_auto_20210317_0218'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='question',
            name='acom_type',
            field=models.CharField(choices=[('PASS', 'Passage'), ('DIG', 'Diagram')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='question',
            name='year',
